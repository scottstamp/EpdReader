#ifndef _GxEPD2_4G_370_GDEY037T03_H_
#define _GxEPD2_4G_370_GDEY037T03_H_

#include <GxEPD2_4G_EPD.h>

class GxEPD2_4G_370_GDEY037T03 : public GxEPD2_4G_EPD
{
  public:
    // attributes
    ...
    // Use an existing panel enum from GxEPD2_4G as dummy metadata
    ...
    // constructor
    GxEPD2_4G_370_GDEY037T03(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    ...
    void powerOff();
    void hibernate();
    void setGrayscaleMode(bool enable) { _grayscale_mode = enable; }
